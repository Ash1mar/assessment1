...
import texteditor.PrintTest1;
import print.wf.common.SystemProperties;
...
public class PrintPreviewDialog extends JDialog implements ActionListener
{
    ...
    public PrintPreviewDialog(Frame parent, String title, boolean modal, PrintTest1 pt, String str)
    {
    ...
    class PreviewCanvas extends JPanel
    {
        ...
        private PrintTest1 preview;

        public PreviewCanvas(PrintTest1 pt, String str)
        {
            printStr = str;
            preview = pt;
        }
